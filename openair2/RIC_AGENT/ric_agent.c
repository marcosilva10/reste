...
#define RICPARAMS_DESC { \
    { RIC_CONFIG_STRING_ENABLED, \
        "yes/no", 0, strptr:"yes", defstrval:"no", TYPE_STRING, 0 }, \
    { RIC_CONFIG_STRING_REMOTE_IPV4_ADDR, \
        NULL, 0, strptr:"10.200.201.243", defstrval: "127.0.0.1", TYPE_STRING, 0 }, \
    { RIC_CONFIG_STRING_REMOTE_PORT, \
        NULL, 0, uptr:RIC_PORT, defintval: RIC_PORT, TYPE_UINT, 0 }  \
}
